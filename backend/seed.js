...
const veiculos = [
  { id: 'vei-001', cliente_id: 'cli-001', modelo: 'Toyota Corolla', placa: 'ABC1234', cor: 'Prata', marca: 'Toyota' },
  { id: 'vei-002', cliente_id: 'cli-002', modelo: 'Honda Civic', placa: 'XYZ9876', cor: 'Preto', marca: 'Honda' },
  { id: 'vei-003', cliente_id: 'cli-003', modelo: 'Volkswagen Gol', placa: 'DEF5678', cor: 'Branco', marca: 'Volkswagen' },
  { id: 'vei-004', cliente_id: 'cli-004', modelo: 'Ford Ka', placa: 'GHI9012', cor: 'Vermelho', marca: 'Ford' },
  { id: 'vei-005', cliente_id: 'cli-005', modelo: 'Chevrolet Onix', placa: 'JKL3456', cor: 'Cinza', marca: 'Chevrolet' },
  { id: 'vei-006', cliente_id: 'cli-006', modelo: 'Hyundai HB20', placa: 'MNO7890', cor: 'Azul', marca: 'Hyundai' },
  { id: 'vei-007', cliente_id: 'cli-007', modelo: 'Fiat Uno', placa: 'PQR1234', cor: 'Verde', marca: 'Fiat' },
  { id: 'vei-008', cliente_id: 'cli-008', modelo: 'Jeep Renegade', placa: 'STU5678', cor: 'Laranja', marca: 'Jeep' },
  { id: 'vei-009', cliente_id: 'cli-009', modelo: 'Nissan Versa', placa: 'VWX9012', cor: 'Preto', marca: 'Nissan' },
  { id: 'vei-010', cliente_id: 'cli-010', modelo: 'Toyota Etios', placa: 'YZA3456', cor: 'Branco', marca: 'Toyota' },
  { id: 'vei-011', cliente_id: 'cli-011', modelo: 'Honda Fit', placa: 'BCD7890', cor: 'Cinza', marca: 'Honda' },
  { id: 'vei-012', cliente_id: 'cli-012', modelo: 'Volkswagen Passat', placa: 'EFG1234', cor: 'Prata', marca: 'Volkswagen' },
  { id: 'vei-013', cliente_id: 'cli-013', modelo: 'Ford EcoSport', placa: 'HIJ5678', cor: 'Vermelho', marca: 'Ford' },
  { id: 'vei-014', cliente_id: 'cli-014', modelo: 'Chevrolet Spin', placa: 'KLM9012', cor: 'Azul', marca: 'Chevrolet' },
  { id: 'vei-015', cliente_id: 'cli-015', modelo: 'Hyundai Creta', placa: 'NOP3456', cor: 'Branco', marca: 'Hyundai' },
  { id: 'vei-016', cliente_id: 'cli-016', modelo: 'Fiat Pulse', placa: 'QRS7890', cor: 'Preto', marca: 'Fiat' },
  { id: 'vei-017', cliente_id: 'cli-017', modelo: 'Jeep Compass', placa: 'TUV1234', cor: 'Cinza', marca: 'Jeep' },
  { id: 'vei-018', cliente_id: 'cli-018', modelo: 'Nissan Kicks', placa: 'WXY5678', cor: 'Vermelho', marca: 'Nissan' },
  { id: 'vei-019', cliente_id: 'cli-019', modelo: 'Toyota Yaris', placa: 'ZAB9012', cor: 'Prata', marca: 'Toyota' },
  { id: 'vei-020', cliente_id: 'cli-020', modelo: 'Honda City', placa: 'CDE3456', cor: 'Branco', marca: 'Honda' },
  { id: 'vei-021', cliente_id: 'cli-021', modelo: 'Volkswagen Virtus', placa: 'FGH7890', cor: 'Azul', marca: 'Volkswagen' },
  { id: 'vei-022', cliente_id: 'cli-022', modelo: 'Ford Territory', placa: 'IJK1234', cor: 'Preto', marca: 'Ford' },
  { id: 'vei-023', cliente_id: 'cli-023', modelo: 'Chevrolet Trailblazer', placa: 'LMN5678', cor: 'Cinza', marca: 'Chevrolet' },
  { id: 'vei-024', cliente_id: 'cli-024', modelo: 'Hyundai Tucson', placa: 'OPQ9012', cor: 'Verde', marca: 'Hyundai' },
  { id: 'vei-025', cliente_id: 'cli-025', modelo: 'Fiat Strada', placa: 'RST3456', cor: 'Branco', marca: 'Fiat' },
  { id: 'vei-026', cliente_id: 'cli-001', modelo: 'Toyota Camry', placa: 'UVW7890', cor: 'Preto', marca: 'Toyota' },
  { id: 'vei-027', cliente_id: 'cli-003', modelo: 'Honda CR-V', placa: 'XYZ1234', cor: 'Cinza', marca: 'Honda' },
];
